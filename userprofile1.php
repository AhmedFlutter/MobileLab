        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6">
            ...
            <div class="sub-heading">
              <p class="mb-4"> We Wellcome You to in Mobile Lab Mr: <?php if(isset($_SESSION['first'])) echo $_SESSION['first']; ?> </p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-8 pl-md-5 pl-sm-0">
            ...
            <p class="text-primary"> Wanna Sell Some Item?  <a href="resell.php#section-resell" type="button" class="btn btn-primary ml-3"> Lets! Order </a> </p>
          </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-8 pr-md-5 pr-sm-0 order-1  mb-5">
            <div class="row">
              <div class="col">
                ...
                <p class="pb_font-20">You Can Easily Contact-us To sell your Un-Usable Cellphones, Tablets and Other Mobile Related Items.</p>
              </div>
            </div>
            <div class="row">
              <div class="col-lg">
            ...
            <div class="d-flex justify-content-start pt-4">
                ...
                <p class="text-primary"> Wanna Repair Some Item?  <a href="repair.php#section-repair" type="button" class="btn btn-primary ml-3"> Lets! Order </a> </p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-5">
             <form action="#" class="bg-white rounded pb_form_v1">
              ...
              <div class="form-group py-2">
                ...
                <input type="text" class="form-control  py-4 reverse name " id="userform" value="<?php if(isset($_SESSION['first'])) echo $_SESSION['first']; ?>" placeholder="Full name">
                <div class="invalid-feedback "> Kindly provide Your Name </div>
              </div>
              <div class="form-group">

                <input type="email" class="form-control py-4 reverse email" id="emailform" value="<?php if(isset($_SESSION['email'])) echo $_SESSION['email']; ?>" placeholder="Email">
                <div class="invalid-feedback "> Kindly provide Your Email </div>
              </div>
              <div class="form-group " >

                <textarea class="form-control reverse message"  style="border-color:none;" id="messageform"  name="" style="height:100px; border-color:#1ebba3;" placeholder="Message" id="web_msg" rows="3"></textarea>
                <div class="invalid-feedback "> Kindly Type Your Query </div>
                </div>

              <div class="form-group">
                <input type="button" id="userbtn"   class="btn btn-primary btn-lg btn-block pb_btn-pill  btn-shadow-blue" value="Send Message">
              </div>
            </form>
          </div>
        </div>
