    ...
    <div class="row">
        ...
        <div class="col-md-12 pt-5">
            <table id="" class="table example table-striped table-dark table-hover table-bordered " style="width:100%;">
                ...
                $sql = "select * from repair_order where employee_id = $id";
                ...
                <td> <button data-toggle='modal' data-target='#employeeModel' id='" . $row['order_repairid'] . "' type='button'admin-id='" . $row['admin_id'] . "' class='btn btn-primary edit' data-id=" . $row['signup_id'] . ">Edit</button> </td>
...
<div class="modal fade" id="employeeModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="update_repair_state.php" method="post">
                <div class="modal-body">
