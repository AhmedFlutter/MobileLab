...
<body>
  ...
  <div style="background-image:url('pic/bg.png');background-size: cover;" class="d-flex" id="wrapper">
    <!-- Sidebar -->
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="livechat/livechat.php" class="list-group-item list-group-item-action bg-light "><i class="fa fa-home"></i> &nbspLive Chat <i class='count'></i></a>
      ...
      <div class="col-xs-2">
        ...
        <div class="notification">
          <img class='notification-btn' src="https://s3.amazonaws.com/codecademy-content/projects/2/feedster/bell.svg">
            <span class='notifcation-count'></span>
